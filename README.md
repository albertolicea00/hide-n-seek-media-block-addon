...
- 🚫 **Force-Blocked Domains (Blacklist)**: Define a list of specific domains where media blocking is _always_ strictly enforced (e.g., blocking cannot be bypassed via toolbar toggles or click-to-reveal on those sites).
